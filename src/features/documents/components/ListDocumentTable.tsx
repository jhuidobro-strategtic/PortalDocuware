...
import { ColumnWidths, Document } from "../types/list.types";
import {
  CurrencyBadge,
  DocumentStatusBadge,
          ...
          <thead className="table-light">
            <tr style={{ textAlign: "center" }}>
              ...
              <ResizableHeader
                ...
                onResize={(w: number) => onResizeColumn("numero", w)}
              >
                {t("Number")}
              </ResizableHeader>
              <ResizableHeader
                width={columnWidths.ruc}
                onResize={(w: number) => onResizeColumn("ruc", w)}
              >
                RUC
              </ResizableHeader>
              <ResizableHeader
                width={columnWidths.razon}
                onResize={(w: number) => onResizeColumn("razon", w)}
              >
                {t("Business Name")}
              </ResizableHeader>
              <ResizableHeader
                width={columnWidths.tipo}
                onResize={(w: number) => onResizeColumn("tipo", w)}
              >
                {t("Document Type")}
              </ResizableHeader>
              <ResizableHeader
              ...
              <ResizableHeader
                ...
                onResize={(w: number) => onResizeColumn("moneda", w)}
              >
                {t("Currency")}
              </ResizableHeader>
              <ResizableHeader
                width={columnWidths.subtotal}
                onResize={(w: number) => onResizeColumn("subtotal", w)}
              >
                {t("Subtotal")}
              </ResizableHeader>
              <ResizableHeader
                width={columnWidths.igv}
                onResize={(w: number) => onResizeColumn("igv", w)}
              >
                IGV
              </ResizableHeader>
              <ResizableHeader
                width={columnWidths.total}
                onResize={(w: number) => onResizeColumn("total", w)}
              >
                {t("Total")}
              </ResizableHeader>
              <ResizableHeader
                width={columnWidths.estado}
                onResize={(w: number) => onResizeColumn("estado", w)}
              >
                {t("Status")}
              </ResizableHeader>
              <ResizableHeader
                width={columnWidths.acciones}
                onResize={(w: number) => onResizeColumn("acciones", w)}
              >
                {t("Actions")}
              </ResizableHeader>
            </tr>
