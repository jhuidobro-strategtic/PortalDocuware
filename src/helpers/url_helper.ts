...
//LOGIN
export const POST_FAKE_LOGIN = "https://docuware-api-a09ab977636d.herokuapp.com/api/users/login/";
export const POST_FAKE_JWT_LOGIN = "https://docuware-api-a09ab977636d.herokuapp.com/api/users/login/";
